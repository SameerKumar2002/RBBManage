...
public class Profit_Calculator_BlackFragment extends Fragment {
    ...
    public Profit_Calculator_BlackFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_profit__calculator__black, container, false);
        ...
        current_bag.setText(String.valueOf(current_service.getCurrentBuy("BLACK BEAN")));
        current_avg.setText(String.valueOf(current_service.getCurrentAverage("BLACK BEAN")));
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                service.insertUserSold(stock,"BLACK");
                if(profit.getDifference_bag_count()!=0 || profit.getDifference_viss_count()!=0){

                    service.updateRemainInfo(profit.getLast_id(),profit.getLast_price(), (int) profit.getDifference_bag_count(),profit.getDifference_viss_count(),"BLACK BEAN");
                }else{
                    service.deleteRemainInfo(profit.getLast_id(),"BLACK BEAN");
                }
