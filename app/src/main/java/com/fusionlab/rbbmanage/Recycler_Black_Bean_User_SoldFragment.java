...
public class Recycler_Black_Bean_User_SoldFragment extends Fragment {

    RecyclerView recyclerView;
    TextView no_data;

    public Recycler_Black_Bean_User_SoldFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_recycler__black__bean__user__sold, container, false);
