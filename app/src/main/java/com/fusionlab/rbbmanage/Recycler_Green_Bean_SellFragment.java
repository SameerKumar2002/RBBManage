...
public class Recycler_Green_Bean_SellFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_recycler__green__bean__sell, container, false);
        ...
        if(service.getAllBag("Green Bean").size()==0){
            ...
            adapter = new SellRecyclerAdapter(getContext(),service.getAllBag("Green Bean"),no_data_lbl);
